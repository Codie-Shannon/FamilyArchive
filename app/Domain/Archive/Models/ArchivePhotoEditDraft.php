...
#[Fillable(['user_id', 'media_item_id', 'source_version_id', 'settings', 'expected_metadata_revision', 'from_source_scan'])]
final class ArchivePhotoEditDraft extends Model
{
    ...
    {
        return ['settings' => 'array', 'expected_metadata_revision' => 'integer', 'from_source_scan' => 'boolean'];
    }
