 ...
 * @property int|null $cloud_import_session_id
 ...
 */
#[Fillable([
    'session_id', 'user_id', 'cloud_import_session_id', 'title', 'source_context', 'automation_preferences',
...
final class UploadSession extends Model
{
    ...
    {
        return [
            'cloud_import_session_id' => 'integer',
