<x-layouts::app :title="__('Dashboard')">
    <div class="flex w-full flex-1 flex-col gap-6">
        ...
        <section class="grid gap-4 rounded-xl border border-zinc-200 bg-white p-5 dark:border-zinc-700 dark:bg-zinc-900 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div><p class="text-xs uppercase tracking-wide text-zinc-500">Build groups</p><p class="mt-1 font-semibold text-zinc-950 dark:text-white">{{ \App\Support\Release::groups() }}</p></div>
            <div><p class="text-xs uppercase tracking-wide text-zinc-500">Status</p><p class="mt-1 font-semibold text-zinc-950 dark:text-white">{{ \App\Support\Release::status() }}</p></div>
        </section>
