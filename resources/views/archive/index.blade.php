...
<div class="mx-auto flex w-full max-w-7xl flex-1 flex-col gap-7 p-4 md:p-8">
    <header class="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div><p class="text-sm font-medium text-emerald-300">Access-filtered family archive</p><h1 class="text-3xl font-semibold text-white">Approved family photos</h1><p class="mt-2 max-w-2xl text-zinc-400">Browse preservation-safe derivatives allowed by your role and family branch. Originals require a separate active grant.</p></div>
