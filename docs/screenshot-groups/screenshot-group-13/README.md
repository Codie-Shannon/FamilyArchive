...
Screenshot Group 13 is the corrective `1.8.0` Restoration Automation release.
...
production-hosting claim belongs to this release.

See [Evidence Index](Evidence_Index.md) for file status and
[Manual Test Plan](../../manual-tests/screenshot-group-13/README.md) for the
capture and validation procedure.
