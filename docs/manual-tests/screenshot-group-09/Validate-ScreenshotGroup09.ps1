...
Invoke-Checked 'Screenshot Group 09 release tests' { php artisan test --compact tests/Feature/Release/RealtimeCommunityReleaseTest.php }
...
Invoke-Checked 'Desktop screenshot quality gate' {
    & .\docs\manual-tests\Test-DesktopScreenshotEvidence.ps1 -EvidencePath @(
        '.\docs\screenshot-groups\screenshot-group-09\01_v140_Community_Spaces.png',
        '.\docs\screenshot-groups\screenshot-group-09\02_v140_Presence_Voice.png',
        '.\docs\screenshot-groups\screenshot-group-09\03_v140_Call_Readiness.png'
    )
}
Invoke-Checked 'Repository evidence state' { git status --short }

Write-Host "`nScreenshot Group 09 validation commands passed." -ForegroundColor Green
Write-Host 'Capture this PowerShell window as 04_v140_Validation.png.' -ForegroundColor Yellow
