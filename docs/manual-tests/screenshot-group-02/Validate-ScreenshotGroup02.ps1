...
Invoke-Checked 'Screenshot Group 02 release tests' { php artisan test --compact tests/Feature/Release/FamilyAccessConversationReleaseTest.php }
...
Write-Host "`nScreenshot Group 02 validation commands passed." -ForegroundColor Green
Write-Host 'Capture this PowerShell window as 07_v028_Validation.png.' -ForegroundColor Yellow
