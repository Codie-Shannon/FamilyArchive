...
Invoke-Checked 'Screenshot Group 03 release tests' { php artisan test --compact tests/Feature/Release/CollaborationRestorationReleaseTest.php }
...
Write-Host "`nScreenshot Group 03 validation commands passed." -ForegroundColor Green
Write-Host 'Capture this PowerShell window as 07_v036_Full_Validation.png.' -ForegroundColor Yellow
