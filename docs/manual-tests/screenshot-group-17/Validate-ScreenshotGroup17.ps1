...
$evidenceDir = Join-Path $repoRoot 'docs\screenshot-groups\screenshot-group-17'
$desktop = @(
    '01_v220_Owner_Command_Centre.png',
    '02_v220_Owner_Work_Queue.png',
    '03_v220_Family_And_Access.png',
    '04_v220_System_And_Storage.png'
)
$mobile = '05_v220_Responsive_Owner_Navigation.png'

Push-Location $repoRoot

try {
    Write-Host '=== Screenshot Group 17 focused tests ===' -ForegroundColor Cyan
    & php -d memory_limit=1G vendor/pestphp/pest/bin/pest tests/Feature/Group17/OwnerCommandCentreTest.php --compact
    ...
    Write-Host "`nScreenshot Group 17 validation commands passed." -ForegroundColor Green
    Write-Host 'Capture this PowerShell window as 06_v220_Validation.png.' -ForegroundColor Yellow
}
finally {
    Pop-Location
}
