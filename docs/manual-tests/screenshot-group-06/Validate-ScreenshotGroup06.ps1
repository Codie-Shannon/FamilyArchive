...
Invoke-Checked 'Screenshot Group 06 release tests' { php artisan test --compact tests/Feature/Release/AdvancedMediaIntelligenceReleaseTest.php }
...
Write-Host "`nScreenshot Group 06 validation commands passed." -ForegroundColor Green
Write-Host 'Capture this PowerShell window as 03_v110_Validation.png.' -ForegroundColor Yellow
