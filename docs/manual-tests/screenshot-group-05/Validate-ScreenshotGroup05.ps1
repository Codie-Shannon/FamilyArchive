...
Invoke-Checked 'Screenshot Group 05 release tests' { php artisan test --compact tests/Feature/Release/V1AcceptanceReleaseTest.php }
...
Write-Host "`nScreenshot Group 05 validation commands passed." -ForegroundColor Green
Write-Host 'Capture this PowerShell window as 07_v100_Complete_Validation.png.' -ForegroundColor Yellow
