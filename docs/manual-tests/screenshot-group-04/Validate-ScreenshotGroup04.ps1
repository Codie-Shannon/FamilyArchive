...
Invoke-Checked 'Screenshot Group 04 release tests' { php artisan test --compact tests/Feature/Release/IntegrityProductionReleaseTest.php }
...
Write-Host "`nScreenshot Group 04 validation commands passed." -ForegroundColor Green
Write-Host 'Capture this PowerShell window as 07_v044_Full_Validation.png.' -ForegroundColor Yellow
