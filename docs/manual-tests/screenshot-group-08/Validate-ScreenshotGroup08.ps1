...
Invoke-Checked 'Screenshot Group 08 release tests' { php artisan test --compact tests/Feature/Release/PublicDiscoveryReleaseTest.php }
...
Invoke-Checked 'Desktop screenshot quality gate' {
    & .\docs\manual-tests\Test-DesktopScreenshotEvidence.ps1 -EvidencePath @(
        '.\docs\screenshot-groups\screenshot-group-08\01_v130_Public_Showcase.png',
        '.\docs\screenshot-groups\screenshot-group-08\02_v130_Archive_Map.png',
        '.\docs\screenshot-groups\screenshot-group-08\03_v130_Publication_Review.png'
    )
}
Invoke-Checked 'Repository evidence state' { git status --short }

Write-Host "`nScreenshot Group 08 validation commands passed." -ForegroundColor Green
Write-Host 'Capture this PowerShell window as 04_v130_Validation.png.' -ForegroundColor Yellow
