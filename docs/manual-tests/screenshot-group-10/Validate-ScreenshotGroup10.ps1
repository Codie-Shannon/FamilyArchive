...
Invoke-Checked 'Screenshot Group 10 release tests' { php artisan test --compact tests/Feature/Release/SecureCommunicationReleaseTest.php }
...
Invoke-Checked 'Desktop screenshot quality gate' {
    & .\docs\manual-tests\Test-DesktopScreenshotEvidence.ps1 -EvidencePath @(
        '.\docs\screenshot-groups\screenshot-group-10\01_v150_Public_DM_Consent.png',
        '.\docs\screenshot-groups\screenshot-group-10\02_v150_Encrypted_Attachments.png',
        '.\docs\screenshot-groups\screenshot-group-10\03_v150_Bot_And_Bridges.png'
    )
}
Invoke-Checked 'Repository evidence state' { git status --short }

Write-Host "`nScreenshot Group 10 validation commands passed." -ForegroundColor Green
Write-Host 'Capture this PowerShell window as 04_v150_Validation.png.' -ForegroundColor Yellow
